...
model = torch.load(pretrain_mm_mlp_adapter, map_location='cpu')
...
pretrained = LlavaLlamaForCausalLM.from_pretrained("LanguageBind/Video-LLaVA-7B")

# Video-Llava fine-tuned from hf
pretrained_hf = AutoModelForCausalLM.from_pretrained("LanguageBind/Video-LLaVA-7B-hf")

backbone.load_state_dict(model, strict=False)
