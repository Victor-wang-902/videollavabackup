...
## HF_DATASETS_OFFLINE=1 TRANSFORMERS_OFFLINE=1 #${JSON_FOLDER}/valley_.json \
unset CUDA_VISIBLE_DEVICES
deepspeed --master_port=29501 --include=localhost:4,5,6,7 videollava/train/train_mem.py \
